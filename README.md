...
This project allows to manage a SQLite database, specifically in this case, a database containing names of people. It provies such functions as adding, removing, printing, checking for existance and searching for certain names in the database. 
